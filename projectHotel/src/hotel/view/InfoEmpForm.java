    ...
    public InfoEmpForm(JFrame jFrame2){
        ...
        applyButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    EmployeeServ.getInstance().edit(new EmployeeEnti().setFullName(nametxt.getText()).setIdNumber(nationC).setPhoneNumber(phonetxt.getText()).setPlace(positiontxt.getText()).setAddress(addresstxt.getText()).setSalary(IncEmp).setUname(register.ucheck));
                }catch (Exception h){
